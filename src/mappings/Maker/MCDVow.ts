...
export function handleLogNoteSetDelay(event: LogNote): void {
    ...
    log.debug("MCDVow  setDelay for spell {} in tx {}", [usr, debug_id])

    let tx = Spell.load(usr)
    if (tx === null) {
        log.debug("MCDVow setDelay. Spell is null in tx {}. {} {} {} {} {}", [debug_id, arg1, arg2, usr, sig, data])
        // TODO - check assumption that only etched spells can be lifted?
    } else {
        log.debug("MCDVow setDelay. Spell found in tx {}. {} {} {} {} {}", [debug_id, arg1, arg2, usr, sig, data])
